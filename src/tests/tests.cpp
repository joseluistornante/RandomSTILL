...
int main() {
	...
	auto test_a = [&] {
		...
		std::cout << std::endl;
		assert(equalsHex(hash, "80cf38cee556e27b1a304b2bdc1aa3b93a6f2e3ed1a6a0f2b4e7fbd3f2270a75"));
	};
	...
	auto test_b = [&] {
		...
		outputHex(std::cout, (const char*)hash, sizeof(hash));
		std::cout << std::endl;
		assert(equalsHex(hash, "fb622344fd64e7a2f93b6b660b97d1e57668075a42a329fc5e302a3122098dbb"));
	};
	...
	auto test_c = [&] {
		...
		outputHex(std::cout, (const char*)hash, sizeof(hash));
		std::cout << std::endl;
		assert(equalsHex(hash, "2534becac5c7594708d435b231e8c3482bf46679a92d3124a59ce82335fc0205"));
	};
	...
	auto test_d = [&] {
		...
		outputHex(std::cout, (const char*)hash, sizeof(hash));
		std::cout << std::endl;
		assert(equalsHex(hash, "66759fa6969545fb3dcc6a6f124cb837c81bff6364d7f7e0af822a4f764b15e9"));
	};
	...
	auto test_e = [&] {
		...
		outputHex(std::cout, (const char*)hash, sizeof(hash));
		std::cout << std::endl;
		assert(equalsHex(hash, "3bbb57a343c6e504adc5afd1673c2d595cbbe33512657f06079eecc292482019"));
	};

	runTest("Hash test 1a (interpreter)", stringsEqual(RANDOMX_ARGON_SALT, "RandomSTILL\x03"), test_a);

	runTest("Hash test 1b (interpreter)", stringsEqual(RANDOMX_ARGON_SALT, "RandomSTILL\x03"), test_b);

	runTest("Hash test 1c (interpreter)", stringsEqual(RANDOMX_ARGON_SALT, "RandomSTILL\x03"), test_c);

	runTest("Hash test 1d (interpreter)", stringsEqual(RANDOMX_ARGON_SALT, "RandomSTILL\x03"), test_d);

	runTest("Hash test 1e (interpreter)", stringsEqual(RANDOMX_ARGON_SALT, "RandomSTILL\x03"), test_e);
	...
	runTest("Hash test 2a (compiler)", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "RandomSTILL\x03"), test_a);

	runTest("Hash test 2b (compiler)", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "RandomSTILL\x03"), test_b);

	runTest("Hash test 2c (compiler)", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "RandomSTILL\x03"), test_c);

	runTest("Hash test 2d (compiler)", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "RandomSTILL\x03"), test_d);

	runTest("Hash test 2e (compiler)", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "RandomSTILL\x03"), test_e);
	...
	runTest("Hash batch test", RANDOMX_HAVE_COMPILER && stringsEqual(RANDOMX_ARGON_SALT, "RandomSTILL\x03"), []() {
		...
		assert(equalsHex(hash1, "80cf38cee556e27b1a304b2bdc1aa3b93a6f2e3ed1a6a0f2b4e7fbd3f2270a75"));
		assert(equalsHex(hash2, "fb622344fd64e7a2f93b6b660b97d1e57668075a42a329fc5e302a3122098dbb"));
		assert(equalsHex(hash3, "2534becac5c7594708d435b231e8c3482bf46679a92d3124a59ce82335fc0205"));
	});
